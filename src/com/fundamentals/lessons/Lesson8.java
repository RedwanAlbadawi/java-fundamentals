...
public class Lesson8 {
    ...
    public void basicIfElseChainExample(int charlie) {
        System.out.println("Before if Statement");
        if (charlie < 30) {
            System.out.println("The values is less than 30");
        } else if (charlie < 40) {
            System.out.println("The values is greater than 40 but " +
                    "less than 30");
        } else {
            System.out.println("The values is greater than 40");
        } // end if/elseif/else
    ...
    public void basicIfAndOrExample(int delta) {
        ...
        if (delta > 100 || delta < 50) {
            System.out.println("The values is not between 100 & 50");
        } // end if
        if (delta % 2 == 0 && delta > 30) {
            System.out.println("The value is greater than30 and an" +
                    " even number");
        } // end if
        System.out.println("End of if statement");
    } // end method
