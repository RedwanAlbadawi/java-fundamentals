...
public class Main {
    ...
    public static void condoExample() {
        ...
        myCondo.doorOpenClose(); // from House class
        myCondo.doorOpenClose("close"); // from House class
    ...
    public static void lesson7Examples() {
        ...
        myLesson7.exampleArtithmatic();
        //myLesson7.addTwoNumbers(); // uncomment for test
